...
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
...
#>   ..$ : chr "manip"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 142 10 142 14 10 14
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..- attr(*, "Rd_tag")= chr "\\keyword"
#>   ..- attr(*, "srcref")= 'srcref' int [1:6] 142 1 142 15 1 15
#>   .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>  $ :List of 13
#>   ..$ : chr "\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
...
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2b309478> 
#>   ..$ : list()
...
#>   .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2b3b92b8> 
#>   .. ..$ :List of 1
#>   .. .. ..$ : chr "default"
#>   .. .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
...
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2b45bc18> 
#>   ..$ : list()
#>   .. ..- attr(*, "Rd_tag")= chr "\\dots"
...
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2b4f6cd8> 
#>   ..$ : chr "\n"
#>   ..$ : chr "seq_len(length.out)\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 2 1 2 20 1 20
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2b585b50> 
#>   ..$ : chr "\n"
#>   ..$ : chr "sequence(nvec, "
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 2 1 2 15 1 15
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2b61bc60> 
#>   ..$ : list()
#>   .. ..- attr(*, "Rd_tag")= chr "\\dots"
...
#>   ..$ : chr "  "
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 1 122 2 1 2
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr [1:2] "\\Sexpr[results=rd,stage=build]{tools:::Rd_expr_bibshow(\"#1\")}" "R:Becker+Chambers+Wilks:1988"
#>   .. ..- attr(*, "Rd_tag")= chr "USERMACRO"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 3 122 40 3 40
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..- attr(*, "macro")= chr "\\bibshow"
#>   ..$ :List of 6
#>   .. ..$ :List of 2
#>   .. .. ..$ :List of 1
#>   .. .. .. ..$ : chr "html"
#>   .. .. .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 41 122 40 41 40
#>   .. .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. .. ..$ :List of 1
#>   .. .. .. ..$ :List of 1
#>   .. .. .. .. ..$ : chr "<span id=\"reference+seq.Rd+R+3ABecker+2BChambers+2BWilks+3A1988\"></span>"
#>   .. .. .. .. .. ..- attr(*, "Rd_tag")= chr "VERB"
#>   .. .. .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 41 122 40 41 40
#>   .. .. .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. .. .. .. ..- attr(*, "Rd_tag")= chr "\\out"
...
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 41 122 40 41 40
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..$ : chr "Becker RA, Chambers JM, Wilks AR (1988).\n"
#>   .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 41 122 40 41 40
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..$ :List of 1
...
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 41 122 40 41 40
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..$ : chr "Chapman and Hall/CRC, London.\n"
#>   .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 41 122 40 41 40
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..$ : chr "ISBN 053409192X."
...
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 41 122 40 41 40
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..- attr(*, "Rd_tag")= chr "LIST"
#>   .. ..- attr(*, "class")= chr "Rd"
#>   ..$ : chr "\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 122 41 122 41 41 41
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..- attr(*, "Rd_tag")= chr "\\references"
#>   ..- attr(*, "srcref")= 'srcref' int [1:6] 121 1 123 1 1 1
#>   .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..- attr(*, "dynamicFlag")= int 6
#>  $ :List of 22
#>   ..$ : chr "\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 124 10 124 10 10 10
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "  The methods "
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 1 125 14 1 14
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ :List of 1
#>   .. ..$ :List of 1
#>   .. .. ..$ : chr "seq.Date"
#>   .. .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 27 125 34 27 34
#>   .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. .. ..- attr(*, "Rd_tag")= chr "\\link"
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 21 125 35 21 35
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..- attr(*, "Rd_tag")= chr "\\code"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 15 125 36 15 36
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr " and "
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 37 125 41 37 41
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ :List of 1
#>   .. ..$ :List of 1
#>   .. .. ..$ : chr "seq.POSIXt"
#>   .. .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 54 125 63 54 63
#>   .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. .. ..- attr(*, "Rd_tag")= chr "\\link"
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 48 125 64 48 64
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..- attr(*, "Rd_tag")= chr "\\code"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 42 125 65 42 65
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr ".\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 125 66 125 67 66 67
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 126 1 126 1 1 1
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "  "
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 127 1 127 2 1 2
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ :List of 1
#>   .. ..$ :List of 1
#>   .. .. ..$ : chr ":"
#>   .. .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 127 15 127 15 15 15
#>   .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. .. ..- attr(*, "Rd_tag")= chr "\\link"
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 127 9 127 16 9 16
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..- attr(*, "Rd_tag")= chr "\\code"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 127 3 127 17 3 17
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr ",\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 127 18 127 19 18 19
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "  "
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 128 1 128 2 1 2
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ :List of 1
#>   .. ..$ :List of 1
#>   .. .. ..$ : chr "rep"
#>   .. .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 128 15 128 17 15 17
#>   .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. .. ..- attr(*, "Rd_tag")= chr "\\link"
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 128 9 128 18 9 18
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..- attr(*, "Rd_tag")= chr "\\code"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 128 3 128 19 3 19
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr ",\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 128 20 128 21 20 21
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "  "
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
...
#>   .. .. ..$ : chr "sequence"
#>   .. .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 129 15 129 22 15 22
#>   .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. .. ..- attr(*, "Rd_tag")= chr "\\link"
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 129 9 129 23 9 23
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..- attr(*, "Rd_tag")= chr "\\code"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 129 3 129 24 3 24
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr ",\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 129 25 129 26 25 26
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "  "
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
...
#>   .. .. ..$ : chr "col"
#>   .. .. .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 131 15 131 17 15 17
#>   .. .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. .. ..- attr(*, "Rd_tag")= chr "\\link"
#>   .. .. ..- attr(*, "srcref")= 'srcref' int [1:6] 131 9 131 18 9 18
#>   .. .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   .. ..- attr(*, "Rd_tag")= chr "\\code"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 131 3 131 19 3 19
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr ".\n"
#>   .. ..- attr(*, "Rd_tag")= chr "TEXT"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 131 20 131 21 20 21
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..- attr(*, "Rd_tag")= chr "\\seealso"
#>   ..- attr(*, "srcref")= 'srcref' int [1:6] 124 1 132 1 1 1
#>   .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>  $ :List of 8
#>   ..$ : chr "\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 133 11 133 11 11 11
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "seq(0, 1, length.out = 11)\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 134 1 134 27 1 27
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "seq(stats::rnorm(20)) # effectively 'along'\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 135 1 135 44 1 44
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "seq(1, 9, by = 2)     # matches 'end'\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 136 1 136 38 1 38
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "seq(1, 9, by = pi)    # stays below 'end'\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 137 1 137 42 1 42
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "seq(1, 6, by = 3)\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 138 1 138 18 1 18
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "seq(1.575, 5.125, by = 0.05)\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 139 1 139 29 1 29
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..$ : chr "seq(17) # same as 1:17, or even better seq_len(17)\n"
#>   .. ..- attr(*, "Rd_tag")= chr "RCODE"
#>   .. ..- attr(*, "srcref")= 'srcref' int [1:6] 140 1 140 51 1 51
#>   .. .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>   ..- attr(*, "Rd_tag")= chr "\\examples"
#>   ..- attr(*, "srcref")= 'srcref' int [1:6] 133 1 141 1 1 1
#>   .. ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>  - attr(*, "dynamicFlag")= int 6
#>  - attr(*, "Rdfile")= chr "/tmp/R-4.6.0/src/library/base/man/seq.Rd"
#>  - attr(*, "class")= chr "Rd"
#>  - attr(*, "meta")=List of 2
#>   ..$ docType  : chr(0) 
#>   ..$ generator: chr ""
#>  - attr(*, "srcref")= 'srcref' int [1:6] 0 0 143 1 0 1
#>   ..- attr(*, "srcfile")=Class 'srcfile' <environment: 0x55af2c9cd8e8> 
#>  - attr(*, "prepared")= int 3
```
