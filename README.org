...
#+RESULTS[eef4a14bfdf18513f7ccc2b1068c87d294b87130]:
...
[[https://github.com/GeoBosh/Rdpack/blob/master/vignettes/Inserting_bibtex_references.pdf][=Inserting_bibtex_references (development version)=]],
[[https://cran.r-project.org/package=Rdpack][=Inserting_bibtex_references (on CRAN)=]], or open it sfrom =R=:
#+BEGIN_EXAMPLE
